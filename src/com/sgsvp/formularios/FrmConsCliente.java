 ...
 */
public class FrmConsCliente extends javax.swing.JInternalFrame {
    ...
    void mostrarclientes(String valor)
    {
        ...
        String mostrar="SELECT * FROM PERSONA WHERE CONCAT(id_tipo_persona,per_apellido,per_cedula,per_cta_bancaria,per_direccion,per_email,per_es_cliente,per_nombre,per_telefono) LIKE '%"+valor+"%'";
    ...
    String []Registros=new String[9];
        ...
        try {
             ...
             while(rs.next())
             {
                  ...
                  Registros[6]= rs.getString("per_cta_bancaria");
            ...
            Logger.getLogger(FrmConsCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
...
// TODO add your handling code here:
    String cod="",nom="",ape="",cta="",dir="",ruc="";
    ...
    try {
        ...
        else
        {
         ...
         cta =  (String)tbclientes.getValueAt(fila, 4);
         ...
         FrmFactura.txtdir.setDisabledTextColor(Color.blue);
         FrmFactura.txtdir.setText(dir);
         FrmFactura.txtdni.setDisabledTextColor(Color.blue);
         FrmFactura.txtdni.setText(cta);
...
// TODO add your handling code here:
    try {
        FrmIngresoCliente ingcli= new FrmIngresoCliente();
        MenuContenedor.escritorio.add(ingcli);
        ingcli.toFront();
