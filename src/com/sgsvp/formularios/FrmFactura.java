...
import com.sgsvp.entidades.GenerarNumero;
...
public class FrmFactura extends javax.swing.JInternalFrame {
          ...
          void descontarstock(String codi,String can)
    {
       ...
       String consul="SELECT * FROM producto WHERE  cod_pro='"+codi+"'";
        ...
        String modi="UPDATE producto SET prod_stock='"+desfinal+"' WHERE cod_producto = '"+codi+"'";
        try {
     ...
     void numeros()
     {
        ...
        String num="";
        String c="";
         String SQL="select max(venta_fac_numero) from venta";
    ...
    void factura(){
       ...
       String InsertarSQL="INSERT INTO venta (fac_numero,id_persona,fac_ruc_ci,fac_sub_total,fac_total_iva,fac_total_venta,fac_fecha) VALUES (?,?,?,?,?,?,?)";
    ...
    private void initComponents() {
        ...
        jLabel3.setText("De nombre_propietario");

        jLabel4.setText("Asunción - Paraguay");

        jLabel5.setText("Telefono: 0982-468-789");

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sgsvp/resource/file-8x.png"))); // NOI18N

        jPanel3.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel15.setText("FACTURA DE VENTA");

        jLabel6.setText("RUC 4994624-2");
        ...
        btnclientes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sgsvp/resource/arrow-circle-left-3x.png"))); // NOI18N
        btnclientes.setText("Asignar Cliente");
        ...
        btnproductos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sgsvp/resource/cart-3x.png"))); // NOI18N
        btnproductos.setText("Añadir Articulo");
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(txtfec, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGap(18, 18, 18)
                                        .addComponent(txtruc, javax.swing.GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
                                        .addGap(271, 271, 271))))))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtigv, javax.swing.GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE)
        ...
        btnguardar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sgsvp/resource/task-3x.png"))); // NOI18N
        ...
        btnsalir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sgsvp/resource/account-logout-3x.png"))); // NOI18N
        ...
        btncalcular.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sgsvp/resource/calculator-3x.png"))); // NOI18N
        ...
        btneliminar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sgsvp/resource/circle-x-3x.png"))); // NOI18N
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(btncalcular, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE)
...
// TODO add your handling code here:
    FrmConsCliente cli = new FrmConsCliente();
    MenuContenedor.escritorio.add(cli);
    //this.toBack();
    cli.toFront();
    cli.show();
    //cli.setVisible(true);
...
// TODO add your handling code here:
    try {
          FrmConsProductos pro= new FrmConsProductos();
    MenuContenedor.escritorio.add(pro);
    pro.toFront();
    pro.setVisible(true);
