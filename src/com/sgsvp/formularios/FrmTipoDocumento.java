...
public class FrmTipoDocumento extends javax.swing.JInternalFrame {
    ...
    void cargar(String valor) {
        try{
            ...
            String cons="select * from tipo_documento WHERE CONCAT (id_tipo_documento,tipo_documento_descripcion) LIKE '%"+valor+"%'";
            Statement st= cn.createStatement();
            ResultSet rs = st.executeQuery(cons);
            while(rs.next()){
                registros[0]=rs.getString("id_tipo_documento");
                registros[1]=rs.getString("tipo_documento_descripcion");
        ...
        try{
            ...
            String cons="select * from tipo_documento WHERE id_tipo_documento='"+cod+"'";
            Statement st = cn.createStatement();
            ResultSet rs = st.executeQuery(cons);
            while(rs.next())
            {
                codi=rs.getString("id_tipo_documento");
                desc=rs.getString("tipo_documento_descripcion");
        ...
        String num="";
        String c="";
         String SQL="select max(id_tipo_documento) from tipo_documento";
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("REGISTRO DE TIPO DE pago");
        ...
        jPanel1.getAccessibleContext().setAccessibleName("Detalle ");
...
// TODO add your handling code here:
       ...
       try {
           ...
           else
           {
             ...
             String eliminarSQL="DELETE FROM tipo_documento WHERE id_tipo_documento = '"+cod+"'";
             try {
...
// TODO add your handling code here:
    ...
    int entidad;
            ...
            entidad= 1;
            sql="INSERT INTO tipo_documento(id_tipo_documento,tipo_documento_descripcion) VALUES (?,?)";
        try {
...
// TODO add your handling code here:
     ...
     String sql="UPDATE tipo_documento SET tipo_documento_descripcion = '"+txtdes.getText()+"' WHERE id_tipo_documento = '"+txtcod.getText()+"'"; 
    try {
        PreparedStatement pst = cn.prepareStatement(sql);
        pst.executeUpdate();
