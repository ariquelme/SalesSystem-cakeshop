...
public class FrmTipoPago extends javax.swing.JInternalFrame {
    ...
    void cargar(String valor) {
        try{
            ...
            String cons="select * from tipo_pago WHERE CONCAT (id_tipo_pago,tipo_pago_descripcion) LIKE '%"+valor+"%'";
            Statement st= cn.createStatement();
            ResultSet rs = st.executeQuery(cons);
            while(rs.next()){
                registros[0]=rs.getString("id_tipo_pago");
                registros[1]=rs.getString("tipo_pago_descripcion");
        ...
        try{
            ...
            String cons="select * from tipo_pago WHERE id_tipo_pago='"+cod+"'";
            Statement st = cn.createStatement();
            ResultSet rs = st.executeQuery(cons);
            while(rs.next())
            {
                codi=rs.getString("id_tipo_pago");
                desc=rs.getString("tipo_pago_descripcion");
        ...
        String num="";
        String c="";
         String SQL="select max(id_tipo_pago) from tipo_pago";
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("REGISTRO TIPO DE PAGO");
...
// TODO add your handling code here:
       ...
       try {
           ...
           else
           {
             ...
             String eliminarSQL="DELETE FROM tipo_pago WHERE id_tipo_pago = '"+cod+"'";
             try {
...
// TODO add your handling code here:
    ...
    int entidad;
            ...
            entidad= 1;
            sql="INSERT INTO tipo_pago (id_tipo_pago,tipo_pago_descripcion,id_entidad_financiera) VALUES (?,?,?)";
        try {
...
// TODO add your handling code here:
     ...
     String sql="UPDATE tipo_pago SET id_entidad_financiera = '"/*+cbosexo.getSelectedItem().toString()*/+entidad_financiera+"',tipo_pago_descripcion = '"+txtdes.getText()+"' WHERE id_tipo_pago = '"+txtcod.getText()+"'"; 
    try {
        PreparedStatement pst = cn.prepareStatement(sql);
        pst.executeUpdate();
