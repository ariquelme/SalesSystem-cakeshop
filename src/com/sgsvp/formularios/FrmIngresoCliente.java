 ...
 */
public class FrmIngresoCliente extends javax.swing.JInternalFrame {
    ...
    String mostrar="SELECT * FROM PERSONA WHERE CONCAT(id_tipo_persona,per_apellido,per_cedula,per_cta_bancaria1,per_direccion,per_email,per_es_cliente,per_nombre,per_telefono) LIKE '%"+valor+"%'";
    String []titulos={"Codigo","Nombres","Apellidos","Es Cliente","CI","Telefono","Cta Cte","Email","Direccion"};
    ...
    model= new DefaultTableModel(null,titulos);
        ...
        try {
              ...
              while(rs.next())
              {
                  Registros[0]= rs.getString("id_tipo_persona");
                  Registros[1]= rs.getString("per_nombre");
                  Registros[2]= rs.getString("per_apellido");
                  Registros[3]= rs.getString("per_es_cliente");
                  Registros[4]= rs.getString("per_cedula");
                  Registros[5]= rs.getString("per_telefono");
                  Registros[6]= rs.getString("per_cta_bancaria1");
                  Registros[7]= rs.getString("per_email");
                  Registros[8]= rs.getString("per_direccion");         
    ...
    void codigosclientes(){
     int j;
        ...
        String num="";
        String c="";
         String SQL="select max(id_tipo_persona) from persona";
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("REGISTRO DE CLIENTES - PROVEEDOR");
        setName(""); // NOI18N
        ...
        jLabel5.setText("Es Cliente?:");

        cbosexo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "S", "N" }));
        ...
        jLabel4.getAccessibleContext().setAccessibleName("C.I.:");
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/sgsvp/resource/magnifying-glass-4x.png"))); // NOI18N
        ...
        jPanel1.getAccessibleContext().setAccessibleName("Detalle Cliente - Proveedor");
...
// TODO add your handling code here:
    ...
    try {
        PreparedStatement pst = cn.prepareStatement("UPDATE PERSONA SET per_nombre='"
                +txtnom.getText()+ "',per_apellido='"
                +txtape.getText()+ "',per_es_cliente='"
                +cbosexo.getSelectedItem()+ "',per_cedula='"
                +txtdni.getText()+ "',per_telefono='"
                +txttel.getText()+ "',per_cta_bancaria1='"
                +txtruc.getText()+ "',per_email='"
                +txtemail.getText()+ "',per_direccion='"
                +txtdir.getText()+ "' WHERE id_tipo_persona='"+txtcod.getText()+"'");
        pst.executeUpdate();
        cargar("");
          bloquear();
    } catch (Exception e) {
...
// TODO add your handling code here:
    String cod,dir,nom,ape,tel,ec,ci,email,cta;
            String sql="";
            cod=txtcod.getText();
            nom=txtnom.getText();
            ape=txtape.getText();
            dir=txtdir.getText();
            tel=txttel.getText();
            ec=cbosexo.getSelectedItem().toString();
            cta=txtruc.getText();
            email= txtemail.getText();
            ci=txtdni.getText();
             
                  
            sql="INSERT INTO persona (id_tipo_persona,per_nombre,per_apellido,per_es_cliente,per_cedula,per_telefono,per_cta_bancaria1,per_email,per_direccion) VALUES (?,?,?,?,?,?,?,?,?)";
        try {
...
// TODO add your handling code here:
    ...
    {
        try {
            PreparedStatement pst = cn.prepareStatement("DELETE FROM persona WHERE id_tipo_persona='"+cod+"'");
            pst.executeUpdate();
            cargar("");
        } catch (SQLException ex) {
            Logger.getLogger(FrmIngresoCliente.class.getName()).log(Level.SEVERE, null, ex);
