 ...
 */
public class FrmConsProductos extends javax.swing.JInternalFrame {
    DefaultTableModel tabla;
    

    /** Creates new form Productos */
    public FrmConsProductos() {
        initComponents();
     ...
     String comparar(String cod)
    {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM producto WHERE cod_producto='"+cod+"'");
            while(rs.next())
            {
                cant=rs.getString(7);
            }
            ...
            Logger.getLogger(FrmConsProductos.class.getName()).log(Level.SEVERE, null, ex);
        }
        return cant;
    ...
    String mostrar="SELECT * FROM producto WHERE CONCAT (cod_producto,'',prod_desc) LIKE '%"+dato+"%'"; 
    Statement st;
        try {
            ...
            while(rs.next())
            {
                ...
                Registro[1]=rs.getString("prod_desc");
                Registro[2]=rs.getString("prod_precio");
                Registro[3]=rs.getString("prod_stock");
