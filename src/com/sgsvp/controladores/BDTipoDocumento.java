...
public  abstract class BDTipoDocumento {
    ...
    public static void insertar(TipoDocumento td) throws SQLException {
        Connection cnn = BD.getConnection();
        PreparedStatement ps = null;
        ps = cnn.prepareStatement("INSERT INTO tipo_documento (tipo_documento_descripcion) VALUES (?)");
    ...
    public static TipoDocumento buscar(int idTipoDocumento) throws SQLException {
        Connection cnn = BD.getConnection();
        PreparedStatement ps = null;
